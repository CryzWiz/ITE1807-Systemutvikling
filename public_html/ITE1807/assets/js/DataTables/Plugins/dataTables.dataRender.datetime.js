...
(function( factory ) {
    "use strict";
    $.getScript("../assets/js/moment-duration-format.js", function(){
...
(function( $, window, document ) {
    ...
    $.fn.dataTable.render.moment = function ( from, to, locale, isduration ) {
        // Argument shifting
        ...
        return function ( d, type, row ) {
            ...
            var ret;
            if(isduration){
                to = window.moment.duration(+d, "seconds").format();
                ret =  ( type === 'sort' || type === 'type') ? m.format('x') : to ;
            }
            else
                ret =  m.format( type === 'sort' || type === 'type' ? 'x' : to );
            return ret;
        };
    };
