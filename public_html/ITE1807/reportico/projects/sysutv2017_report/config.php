...
define('SW_PROJECT_TITLE', 'Morild Data BA');
...
define('SW_DB_USER', 'stud_v17_gruppe1');
define('SW_DB_PASSWORD', 'gruppe1');
define('SW_DB_HOST', 'kark.uit.no');
define('SW_DB_DATABASE', 'stud_v17_gruppe1');
}
