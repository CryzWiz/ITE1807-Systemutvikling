...
/**
 * Base class that represents a row from the 'work_status' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class WorkStatus implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\WorkStatusTableMap';
    ...
    /**
     * Initializes internal state of Base\WorkStatus object.
     */
    ...
    /**
     * Compares this with another <code>WorkStatus</code> instance.  If
     * <code>obj</code> is an instance of <code>WorkStatus</code>, delegates to
     * <code>equals(WorkStatus)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|WorkStatus The current object, for fluid interface
     */
     ...
     * @return $this|\WorkStatus The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[WorkStatusTableMap::COL_ID] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[WorkStatusTableMap::COL_STATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WorkStatusTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WorkStatusTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = WorkStatusTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\WorkStatus'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWorkStatusQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see WorkStatus::setDeleted()
     * @see WorkStatus::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWorkStatusQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WorkStatusTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WorkStatusTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(WorkStatusTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'Status';
        }

        $sql = sprintf(
            'INSERT INTO work_status (%s) VALUES (%s)',
    ...
    {
        $pos = WorkStatusTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['WorkStatus'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['WorkStatus'][$this->hashCode()] = true;
        $keys = WorkStatusTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(WorkStatusTableMap::DATABASE_NAME);

        if ($this->isColumnModified(WorkStatusTableMap::COL_ID)) {
            $criteria->add(WorkStatusTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(WorkStatusTableMap::COL_STATUS)) {
            $criteria->add(WorkStatusTableMap::COL_STATUS, $this->status);
        }
    ...
    {
        $criteria = ChildWorkStatusQuery::create();
        $criteria->add(WorkStatusTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \WorkStatus (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \WorkStatus Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildWorkStatus is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildWorkStatus The current object (for fluent API support)
     */
    public function setProjects(Collection $projects, ConnectionInterface $con = null)
    {
        ...
        foreach ($projectsToDelete as $projectRemoved) {
            $projectRemoved->setWorkStatus(null);
        }
    ...
    public function setTasks(Collection $tasks, ConnectionInterface $con = null)
    {
        ...
        foreach ($tasksToDelete as $taskRemoved) {
            $taskRemoved->setWorkStatus(null);
        }
     ...
     * Otherwise if this WorkStatus is new, it will return
     * an empty collection; or if this WorkStatus has previously
     * been saved, it will retrieve related Tasks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in WorkStatus.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTask[] List of ChildTask objects
     */
    public function getTasksJoinTeamProject(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTaskQuery::create(null, $criteria);
        $query->joinWith('TeamProject', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(WorkStatusTableMap::DEFAULT_STRING_FORMAT);
    }
