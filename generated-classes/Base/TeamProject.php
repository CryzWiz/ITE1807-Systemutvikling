...
/**
 * Base class that represents a row from the 'team_project' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class TeamProject implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TeamProjectTableMap';
    ...
    /**
     * Initializes internal state of Base\TeamProject object.
     */
    ...
    /**
     * Compares this with another <code>TeamProject</code> instance.  If
     * <code>obj</code> is an instance of <code>TeamProject</code>, delegates to
     * <code>equals(TeamProject)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TeamProject The current object, for fluid interface
     */
     ...
     * @return $this|\TeamProject The current object (for fluent API support)
     */
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[TeamProjectTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setTeamId($v)
    {
        ...
        if ($this->team_id !== $v) {
            $this->team_id = $v;
            $this->modifiedColumns[TeamProjectTableMap::COL_TEAM_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TeamProjectTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TeamProjectTableMap::translateFieldName('TeamId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = TeamProjectTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TeamProject'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTeamProjectQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TeamProject::setDeleted()
     * @see TeamProject::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTeamProjectQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TeamProjectTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TeamProjectTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'Project_id';
        }
        if ($this->isColumnModified(TeamProjectTableMap::COL_TEAM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'Team_id';
        }

        $sql = sprintf(
            'INSERT INTO team_project (%s) VALUES (%s)',
    ...
    {
        $pos = TeamProjectTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TeamProject'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TeamProject'][$this->hashCode()] = true;
        $keys = TeamProjectTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TeamProjectTableMap::COL_PROJECT_ID)) {
            $criteria->add(TeamProjectTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(TeamProjectTableMap::COL_TEAM_ID)) {
            $criteria->add(TeamProjectTableMap::COL_TEAM_ID, $this->team_id);
        }
    ...
    {
        $criteria = ChildTeamProjectQuery::create();
        $criteria->add(TeamProjectTableMap::COL_PROJECT_ID, $this->project_id);
        $criteria->add(TeamProjectTableMap::COL_TEAM_ID, $this->team_id);
    ...
    public function hashCode()
    {
        ...
        //relation team_project_fk_601850 to table project
        ...
        //relation team_project_fk_f0e437 to table team
    ...
    {
        return (null === $this->getProjectId()) && (null === $this->getTeamId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TeamProject (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TeamProject Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProject(ConnectionInterface $con = null)
    {
        if ($this->aProject === null && ($this->project_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProject->addTeamProjects($this);
             */
        }
    ...
    public function getTeam(ConnectionInterface $con = null)
    {
        if ($this->aTeam === null && ($this->team_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTeam->addTeamProjects($this);
             */
        }
     ...
     * If this ChildTeamProject is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTeamProject The current object (for fluent API support)
     */
    public function setTasks(Collection $tasks, ConnectionInterface $con = null)
    {
        ...
        foreach ($tasksToDelete as $taskRemoved) {
            $taskRemoved->setTeamProject(null);
        }
     ...
     * Otherwise if this TeamProject is new, it will return
     * an empty collection; or if this TeamProject has previously
     * been saved, it will retrieve related Tasks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TeamProject.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTask[] List of ChildTask objects
     */
    public function getTasksJoinWorkStatus(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTaskQuery::create(null, $criteria);
        $query->joinWith('WorkStatus', $joinBehavior);
    ...
    {
        if (null !== $this->aProject) {
            $this->aProject->removeTeamProject($this);
        }
        if (null !== $this->aTeam) {
            $this->aTeam->removeTeamProject($this);
        }
    ...
    {
        return (string) $this->exportTo(TeamProjectTableMap::DEFAULT_STRING_FORMAT);
    }
