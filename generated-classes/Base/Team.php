...
abstract class Team implements ActiveRecordInterface 
{
    ...
    public function setTimeRegistrations(Collection $timeRegistrations, ConnectionInterface $con = null)
    {
        ...
        foreach ($timeRegistrationsToDelete as $timeRegistrationRemoved) {
            $timeRegistrationRemoved->setTeam(null);
        }
     ...
     * @return ObjectCollection|ChildUserTeam[] List of ChildUserTeam objects
     */
    public function getUserTeamsJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserTeamQuery::create(null, $criteria);
        $query->joinWith('User', $joinBehavior);
    ...
    public function setTeamProjects(Collection $teamProjects, ConnectionInterface $con = null)
    {
        ...
        foreach ($teamProjectsToDelete as $teamProjectRemoved) {
            $teamProjectRemoved->setTeam(null);
        }
     ...
     * @return ObjectCollection|ChildTeamProject[] List of ChildTeamProject objects
     */
    public function getTeamProjectsJoinProject(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTeamProjectQuery::create(null, $criteria);
