 ...
 *
 * @method     ChildTeamQuery leftJoinTimeRegistration($relationAlias = null) Adds a LEFT JOIN clause to the query using the TimeRegistration relation
 * @method     ChildTeamQuery rightJoinTimeRegistration($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TimeRegistration relation
 * @method     ChildTeamQuery innerJoinTimeRegistration($relationAlias = null) Adds a INNER JOIN clause to the query using the TimeRegistration relation
 *
 * @method     ChildTeamQuery joinWithTimeRegistration($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the TimeRegistration relation
 *
 * @method     ChildTeamQuery leftJoinWithTimeRegistration() Adds a LEFT JOIN clause and with to the query using the TimeRegistration relation
 * @method     ChildTeamQuery rightJoinWithTimeRegistration() Adds a RIGHT JOIN clause and with to the query using the TimeRegistration relation
 * @method     ChildTeamQuery innerJoinWithTimeRegistration() Adds a INNER JOIN clause and with to the query using the TimeRegistration relation
 *
 * @method     ChildTeamQuery leftJoinUserTeam($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserTeam relation
 * @method     ChildTeamQuery rightJoinUserTeam($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserTeam relation
 * @method     ChildTeamQuery innerJoinUserTeam($relationAlias = null) Adds a INNER JOIN clause to the query using the UserTeam relation
 *
 * @method     ChildTeamQuery joinWithUserTeam($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the UserTeam relation
 *
 * @method     ChildTeamQuery leftJoinWithUserTeam() Adds a LEFT JOIN clause and with to the query using the UserTeam relation
 * @method     ChildTeamQuery rightJoinWithUserTeam() Adds a RIGHT JOIN clause and with to the query using the UserTeam relation
 * @method     ChildTeamQuery innerJoinWithUserTeam() Adds a INNER JOIN clause and with to the query using the UserTeam relation
 *
 * @method     ChildTeamQuery leftJoinTeamProject($relationAlias = null) Adds a LEFT JOIN clause to the query using the TeamProject relation
 * @method     ChildTeamQuery rightJoinTeamProject($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TeamProject relation
 * @method     ChildTeamQuery innerJoinTeamProject($relationAlias = null) Adds a INNER JOIN clause to the query using the TeamProject relation
 *
 * @method     ChildTeamQuery joinWithTeamProject($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the TeamProject relation
 *
 * @method     ChildTeamQuery leftJoinWithTeamProject() Adds a LEFT JOIN clause and with to the query using the TeamProject relation
 * @method     ChildTeamQuery rightJoinWithTeamProject() Adds a RIGHT JOIN clause and with to the query using the TeamProject relation
 * @method     ChildTeamQuery innerJoinWithTeamProject() Adds a INNER JOIN clause and with to the query using the TeamProject relation
 *
 * @method     \TimeRegistrationQuery|\UserTeamQuery|\TeamProjectQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class TeamQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'local', $modelName = '\\Team', $modelAlias = null)
    {
    ...
    public function filterByTimeRegistration($timeRegistration, $comparison = null)
    {
        if ($timeRegistration instanceof \TimeRegistration) {
            return $this
                ->addUsingAlias(TeamTableMap::COL_ID, $timeRegistration->getTeamId(), $comparison);
    ...
    public function filterByUserTeam($userTeam, $comparison = null)
    {
        if ($userTeam instanceof \UserTeam) {
            return $this
                ->addUsingAlias(TeamTableMap::COL_ID, $userTeam->getTeamId(), $comparison);
    ...
    public function filterByTeamProject($teamProject, $comparison = null)
    {
        if ($teamProject instanceof \TeamProject) {
            return $this
                ->addUsingAlias(TeamTableMap::COL_ID, $teamProject->getTeamId(), $comparison);
