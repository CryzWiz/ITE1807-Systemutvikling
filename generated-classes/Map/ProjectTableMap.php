...
class ProjectTableMap extends TableMap
{
     ...
     */
    const COL_START = 'project.Start';

    /**
     * the column name for the End field
     */
    const COL_END = 'project.End';

    /**
     * the column name for the Status_id field
     */
    const COL_STATUS_ID = 'project.Status_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Start', 'End', 'StatusId', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'start', 'end', 'statusId', ),
        self::TYPE_COLNAME       => array(ProjectTableMap::COL_ID, ProjectTableMap::COL_NAME, ProjectTableMap::COL_START, ProjectTableMap::COL_END, ProjectTableMap::COL_STATUS_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'Name', 'Start', 'End', 'Status_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Start' => 2, 'End' => 3, 'StatusId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'start' => 2, 'end' => 3, 'statusId' => 4, ),
        self::TYPE_COLNAME       => array(ProjectTableMap::COL_ID => 0, ProjectTableMap::COL_NAME => 1, ProjectTableMap::COL_START => 2, ProjectTableMap::COL_END => 3, ProjectTableMap::COL_STATUS_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'Name' => 1, 'Start' => 2, 'End' => 3, 'Status_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Calendar', '\\Calendar', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':Project_id',
    1 => ':id',
  ),
), null, null, 'Calendars', false);
        $this->addRelation('TeamProject', '\\TeamProject', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':Project_id',
    1 => ':id',
  ),
), null, null, 'TeamProjects', false);
        $this->addRelation('ProjectInfo', '\\ProjectInfo', RelationMap::ONE_TO_ONE, array (
  0 =>
  array (
    0 => ':Project_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProjectTableMap::COL_START);
            $criteria->addSelectColumn(ProjectTableMap::COL_END);
            $criteria->addSelectColumn(ProjectTableMap::COL_STATUS_ID);
        } else {
